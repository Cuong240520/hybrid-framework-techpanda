...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.PROJECT_PATH + "/htmlExtentReport/ExtentReport_V5.html");
		...
		extentReports.setSystemInfo("Team", "Automation Dean Tran");
